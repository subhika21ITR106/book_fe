...
const CheckoutForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://book-be.onrender.com/api/users", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
        ...
        <div className="form-box">
          ...
          <div className="row my-4 h-100">
            <div className="col-md-4 col-lg-4 col-sm-8 mx-auto">
              <form onSubmit={handleSubmit}>
                <div className="my-3">
                  <label htmlFor="floatingInput">Email address</label><br></br>
                  <input
                    type="email"
                    className="form-control"
                    id="floatingInput"
                ...
                <div className="my-3">
                  <label htmlFor="floatingPassword display-4">Password</label><br></br>
                  <input
                    type="password"
                    className="form-control"
                    id="floatingPassword"
                ...
                {/* Additional inputs */}
                <div className="my-3">
                  <label htmlFor="country">Country/Region</label><br></br>
                  <input
                    type="text"
                    className="form-control"
                    id="country"
